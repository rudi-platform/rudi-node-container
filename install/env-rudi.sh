...
GLOBAL_VARS="${GLOBAL_VARS} MEDIA_DIR PORTAL_URL PORTAL_USER PORTAL_PASS PORTAL_REQ_TIMEOUT PORTAL_MAX_RETRIES PORTAL_INITIAL_DELAY TRUSTED_DOMAINS"
GLOBAL_VARS="${GLOBAL_VARS} JWTAUTH_PORT JWTAUTH_LOCAL_URL LOCAL_INTERFACE LOCAL_URL"
GLOBAL_VARS="${GLOBAL_VARS} CATALOG_PORT CATALOG_LOCAL_URL CATALOG_PREFIX CATALOG_PUBLIC_URL CATALOG_AUTO_UPDATE_SCHEMA BACKUP_DIR"
