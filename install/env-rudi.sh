...
NODE_JWTAUTH_PORT=${NODE_JWTAUTH_PORT:-$((${NODE_BASE_PORT}+3))}
...
JWTAUTH_LOCAL_URL=${JWTAUTH_LOCAL_URL:-${LOCAL_URL}:${NODE_JWTAUTH_PORT}}
...
GLOBAL_VARS="${GLOBAL_VARS} NODE_CATALOG_PORT NODE_STORAGE_PORT NODE_MANAGER_PORT NODE_JWTAUTH_PORT"
GLOBAL_VARS="${GLOBAL_VARS} LOCAL_INTERFACE LOCAL_URL CATALOG_LOCAL_URL STORAGE_LOCAL_URL MANAGER_LOCAL_URL JWTAUTH_LOCAL_URL"
